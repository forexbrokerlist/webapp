  ...
  return (
    <>
      <TextBanner
        ...
        description="manage your account and brokers on forex brokers listing."
      />
      <div className="pt-[40px] pb-100 max-mobile:pb-16 max-mobile:pt-[120px]">
        <div className="max-w-[1640px] px-5 max-laptop:px-16 mx-auto relative max-tab:px-5 max-mobile:px-4">
          <div className="w-full space-y-6">
            {/* <div className="flex items-center justify-between">
              <H2>Campaign Analytics</H2>
              <Button onClick={downloadCSV} variant="secondary" className="text-base" prefix={<DownloadIcon />}>
                Download CSV Report
              </Button>
            </div> */}
