                                    ...
                                    <div className='pt-5 flex flex-col flex-1'>
                                        ...
                                        <div className='grid grid-cols-2 gap-3 pt-2 mt-auto'>
                                            ...
                                            <Button
                                                ...
                                                className={`px-5 max-mobile:px-3 col-span-2 max-mobile:gap-1.5 gap-2.5 group rounded-full relative z-[9] border transition-all  bg-black100 text-white border-[rgba(26,26,26,0.10)] `}
                                            >
                                                ...
                                                <div className={`w-7 h-7 max-mobile:w-6 max-mobile:h-6 rounded-full flex items-center justify-center transition-all duration-300
                                                    ${item.analyzed ? 'bg-black100/40 group-hover:bg-primary ' : 'bg-black100 group-hover:bg-primary'}`}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
