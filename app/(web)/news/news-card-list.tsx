...
export default function NewsCardList({ activeSource }: NewsCardListProps) {
    ...
    const [prevActiveSource, setPrevActiveSource] = useState(activeSource)
                                    ...
                                    <div className='pt-5 flex flex-col flex-1'>
                                        ...
                                        <div className='grid grid-cols-2 gap-3 pt-2 mt-auto'>
                                            ...
                                            <Button
                                                ...
                                                className={`px-5 max-mobile:px-3 col-span-2 max-mobile:gap-1.5 gap-2.5 group rounded-full relative z-[9] border transition-all ${
                                                    item.analyzed
                                                        ? 'bg-[#F4F4F4] hover:bg-[#EAEAEA]! text-[#1A1A1A] hover:text-[#1A1A1A]! border-transparent!'
                                                        : 'bg-black100 text-white border-[rgba(26,26,26,0.10)]'
                                                }`}
                                            >
                                                {analyzingId === item.id ? 'Analyzing' : item.analyzed ? `${item?.impact_score || 0}/10 Impact` : 'Analyze'}
