...
export const Hero = ({ className, ...props }: ComponentProps<"section">) => {
  return (
    <>
      ...
      <section className="relative max-mobile:pb-16 min-h-[calc(100dvh-50px)] max-tab:min-h-auto" {...props}>
        <div className="max-w-[1640px] px-5 mx-auto max-laptop:px-16 max-tab:px-5 max-mobile:px-4">
          <div className="relative">
            ...
            <div className="max-w-[800px] pt-[200px] max-mobile:pt-[120px] max-laptop:pt-[150px] max-tab:pt-[160px] max-laptop:max-w-[700px]">
              ...
              <motion.h1
                className="text-[72px] font-bold max-mobile:text-4xl max-mobile:leading-[45px] leading-[80px] max-laptop:text-[60px] max-laptop:leading-[70px] text-black100 font-monda my-3"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.p
                className="text-lg max-w-[710px] max-mobile:text-base max-mobile:mb-5 font-medium text-black700 mb-9"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                className="pt-[50px] max-mobile:pt-[30px] flex items-center max-mobile:grid max-mobile:grid-cols-2 max-mobile:gap-5"
                initial="hidden"
                animate="visible"
                variants={{
                  hidden: { opacity: 0 },
