...
const Fxcublc = '/assets/images/fxcublc.svg';

export default function BidgeAndPlug() {
    return (
                            ...
                            return (
                                ...
                                >
                                    <div className='bg-[#f0f2ec] w-[128px] h-[128px] rounded-full absolute -right-[26px] -top-[26px] flex items-center justify-center pointer-events-none'>
                                        <div className='w-[97px] h-[97px] bg-white rounded-full flex items-center justify-center shadow-[0_2px_15px_rgba(0,0,0,0.05)] pointer-events-auto border-[0.5px] border-gray-100'>
                                            <img src={Fxcublc} alt="Fxcublc" className='block' />
                                        </div>
                                    </div>
                                    ...
                                    <p className='text-base text-black700 font-medium mb-5'>
                                    ...
                                    <div className='py-1.5 px-2.5 text-sm text-black700 font-medium border border-solid border-border-gray800 bg-white rounded-full flex items-center gap-2'>
                                        <CheckIcon />
                                        Used by 150+ Brokers
                                    </div>
                                    <div className='pt-5'>
