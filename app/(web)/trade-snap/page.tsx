'use client'
import { AlertCircle, ArrowDownRight, ArrowUpRight, BarChart3, Camera, CameraIcon, Clock, Eye, Monitor, MonitorOff, Play, Slash, Smartphone, Square, TrendingDown, TrendingUp, Zap } from "lucide-react";
