...
export default async function () {
  ...
  return (
    <>
      <CommonBanner highlightedText={title[0] + " Policy - "} title={" Protecting Your Data & Information"} description={metadata.description} image="/assets/images/PrivacyPolicy.png" />
           ...
           <div className="py-20 max-mobile:py-12 ">
              ...
              <p>
                ...
                <a href="https://forexbrokerlist.io" target="_blank">forexbrokerlist.io</a>.
              </p>
